...
//go:generate minimock -i github.com/GalichAnton/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, user *user.Info) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, user *user.Info)
	...
	funcGet          func(ctx context.Context, id int64) (up1 *user.User, err error)
	inspectFuncGet   func(ctx context.Context, id int64)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mUserRepositoryMockGet

	funcGetByEmail          func(ctx context.Context, email string) (up1 *user.User, err error)
	...
	funcUpdate          func(ctx context.Context, id int64, info *user.Info) (err error)
	inspectFuncUpdate   func(ctx context.Context, id int64, info *user.Info)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, user *user.Info) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, user *user.Info)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, user *user.Info) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, user *user.Info) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, user *user.Info) (i1 int64, err error) {
...
func (mmGet *mUserRepositoryMockGet) Return(up1 *user.User, err error) *UserRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, id int64) (up1 *user.User, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetExpectation) Then(up1 *user.User, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetResults{up1, err}
	return e.mock
}

// Get implements repository.UserRepository
func (mmGet *UserRepositoryMock) Get(ctx context.Context, id int64) (up1 *user.User, err error) {
...
func (mmGetByEmail *mUserRepositoryMockGetByEmail) Return(up1 *user.User, err error) *UserRepositoryMock {
	if mmGetByEmail.mock.funcGetByEmail != nil {
		mmGetByEmail.mock.t.Fatalf("UserRepositoryMock.GetByEmail mock is already set by Set")
	}
...
func (mmGetByEmail *mUserRepositoryMockGetByEmail) Set(f func(ctx context.Context, email string) (up1 *user.User, err error)) *UserRepositoryMock {
	if mmGetByEmail.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetByEmailExpectation) Then(up1 *user.User, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetByEmailResults{up1, err}
	return e.mock
}

// GetByEmail implements repository.UserRepository
func (mmGetByEmail *UserRepositoryMock) GetByEmail(ctx context.Context, email string) (up1 *user.User, err error) {
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, id int64, info *user.Info) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, id int64, info *user.Info)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, id int64, info *user.Info) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, id int64, info *user.Info) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, id int64, info *user.Info) (err error) {
