...
//go:generate minimock -i github.com/GalichAnton/auth/internal/services.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, user *modelService.ToCreate) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, user *modelService.ToCreate)
	...
	funcGet          func(ctx context.Context, id int64) (up1 *modelService.User, err error)
	inspectFuncGet   func(ctx context.Context, id int64)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mUserServiceMockGet

	funcUpdate          func(ctx context.Context, id int64, info *modelService.Info) (err error)
	inspectFuncUpdate   func(ctx context.Context, id int64, info *modelService.Info)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, user *modelService.ToCreate) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, user *modelService.ToCreate)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, user *modelService.ToCreate) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, user *modelService.ToCreate) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, user *modelService.ToCreate) (i1 int64, err error) {
...
func (mmGet *mUserServiceMockGet) Return(up1 *modelService.User, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id int64) (up1 *modelService.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(up1 *modelService.User, err error) *UserServiceMock {
	e.results = &UserServiceMockGetResults{up1, err}
	return e.mock
}

// Get implements services.UserService
func (mmGet *UserServiceMock) Get(ctx context.Context, id int64) (up1 *modelService.User, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, info *modelService.Info) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, info *modelService.Info)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, info *modelService.Info) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, info *modelService.Info) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, info *modelService.Info) (err error) {
