...
//go:generate minimock -i github.com/GalichAnton/auth/internal/services.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
// AuthServiceMock implements services.AuthService
...
// NewAuthServiceMock returns a mock for services.AuthService
...
func (mmGetAccessToken *mAuthServiceMockGetAccessToken) Expect(ctx context.Context, accessToken string) *mAuthServiceMockGetAccessToken {
	...
	mmGetAccessToken.defaultExpectation.params = &AuthServiceMockGetAccessTokenParams{ctx, accessToken}
...
func (mmGetAccessToken *mAuthServiceMockGetAccessToken) Inspect(f func(ctx context.Context, accessToken string)) *mAuthServiceMockGetAccessToken {
...
// Then helper
func (mmGetAccessToken *mAuthServiceMockGetAccessToken) When(ctx context.Context, accessToken string) *AuthServiceMockGetAccessTokenExpectation {
	if mmGetAccessToken.mock.funcGetAccessToken != nil {
		mmGetAccessToken.mock.t.Fatalf("AuthServiceMock.GetAccessToken mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockGetAccessTokenExpectation{
		...
		params: &AuthServiceMockGetAccessTokenParams{ctx, accessToken},
	}
...
func (mmGetAccessToken *AuthServiceMock) GetAccessToken(ctx context.Context, accessToken string) (sp1 *string, err error) {
	...
	if mmGetAccessToken.inspectFuncGetAccessToken != nil {
		mmGetAccessToken.inspectFuncGetAccessToken(ctx, accessToken)
	}

	mm_params := AuthServiceMockGetAccessTokenParams{ctx, accessToken}
	...
	if mmGetAccessToken.GetAccessTokenMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockGetAccessTokenParams{ctx, accessToken}
	...
	mmGetAccessToken.t.Fatalf("Unexpected call to AuthServiceMock.GetAccessToken. %v %v", ctx, accessToken)
	return
}
...
func (mmLogin *mAuthServiceMockLogin) Expect(ctx context.Context, login *modelService.Login) *mAuthServiceMockLogin {
	...
	mmLogin.defaultExpectation.params = &AuthServiceMockLoginParams{ctx, login}
...
func (mmLogin *mAuthServiceMockLogin) Inspect(f func(ctx context.Context, login *modelService.Login)) *mAuthServiceMockLogin {
...
// Then helper
func (mmLogin *mAuthServiceMockLogin) When(ctx context.Context, login *modelService.Login) *AuthServiceMockLoginExpectation {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("AuthServiceMock.Login mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockLoginExpectation{
		mock:   mmLogin.mock,
		params: &AuthServiceMockLoginParams{ctx, login},
	}
...
func (mmLogin *AuthServiceMock) Login(ctx context.Context, login *modelService.Login) (sp1 *string, err error) {
	...
	if mmLogin.inspectFuncLogin != nil {
		mmLogin.inspectFuncLogin(ctx, login)
	}

	mm_params := AuthServiceMockLoginParams{ctx, login}
	...
	if mmLogin.LoginMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockLoginParams{ctx, login}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmLogin.t.Fatalf("Unexpected call to AuthServiceMock.Login. %v %v", ctx, login)
	return
}
