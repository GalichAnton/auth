...
//go:generate minimock -i github.com/GalichAnton/auth/internal/repository.LogRepository -o log_repository_minimock.go -n LogRepositoryMock -p mocks
...
type LogRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, log *log.Info) (err error)
	inspectFuncCreate   func(ctx context.Context, log *log.Info)
...
func (mmCreate *mLogRepositoryMockCreate) Expect(ctx context.Context, log *log.Info) *mLogRepositoryMockCreate {
...
func (mmCreate *mLogRepositoryMockCreate) Inspect(f func(ctx context.Context, log *log.Info)) *mLogRepositoryMockCreate {
...
func (mmCreate *mLogRepositoryMockCreate) Set(f func(ctx context.Context, log *log.Info) (err error)) *LogRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mLogRepositoryMockCreate) When(ctx context.Context, log *log.Info) *LogRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("LogRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *LogRepositoryMock) Create(ctx context.Context, log *log.Info) (err error) {
